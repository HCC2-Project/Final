...
<div class="qheader">
16) Which of the following is the correct order of the processing cycle of a computer?</div>
<div class="qselections">
<input type="radio" value="a" name="question16"> a) processing,, input, memory, output<br>
<input type="radio" value="b" name="question16"> b) output, input, memory, processing<br>
<input type="radio" value="c" name="question16"> c) input, memory , processing, output<br>
<input type="radio" value="d" name="question16"> d) memory, input, output, processing<br>
</div>

<hr class="featurette-quizhr">
 
<div class="qheader">
17) What device is BOTH an input and output device?</div>
<div class="qselections">
<input type="radio" value="a" name="question17"> a) printer<br>
<input type="radio" value="b" name="question17"> b) disk<br>
<input type="radio" value="c" name="question17"> c) monitor<br>
<input type="radio" value="d" name="question17"> d) keyboard<br>
</div>

<hr class="featurette-quizhr">

<div class="qheader">
18)Which software firm is the second largest in the world, after Microsoft?</div>
<div class="qselections">
<input type="radio" value="a" name="question18"> a) Netscape<br>
<input type="radio" value="b" name="question18"> b) Oracle<br>
<input type="radio" value="c" name="question18"> c) Lotus<br>
<input type="radio" value="d" name="question18"> d) Norton<br>
</div>

<hr class="featurette-quizhr">

<div class="qheader">
19) As of January 2003, how much is Microsoft Chairman Bill Gates\'s net worth?</div>
<div class = "qselections">
<input type = "radio" value = "a" name = "question19"> a) 10 million US<br>
<input type = "radio" value = "b" name = "question19"> b) 20 billion US<br>
<input type = "radio" value = "c" name = "question19"> c) 35 billion US<br>
<input type = "radio" value = "d" name = "question19"> d) 50 billion US<br>
</div>
...
<div class="qheader">
23)Joseph Jacquard used to control he operations of his loom?</div>
<div class="qselections">
<input type="radio" value="a" name="question23"> a) Vacuum tubes<br>
<input type="radio" value="b" name="question23"> b) electricity<br>
<input type="radio" value="c" name="question23"> c) transistors<br>
<input type="radio" value="d" name="question23"> d) punched cards<br>
</div>

<hr class="featurette-quizhr">

<div class="qheader">
24) The Fourth Generation of computers used this to control operations:</div>
<div class="qselections">
<input type="radio" value="a" name="question24"> a) integrated circuits<br>
<input type="radio" value="b" name="question24"> b) transistors<br>
<input type="radio" value="c" name="question24"> c) microchips<br>
<input type="radio" value="d" name="question24"> d) vacuum tubes<br>
</div>

<hr class="featurette-quizhr">

<div class="qheader">
25) The arithmetic/logic unit of the computer:</div>
<div class="qselections">
<input type="radio" value="a" name="question25"> a) can add numbers<br>
<input type="radio" value="b" name="question25"> b) can compare numbers<br>
<input type="radio" value="c" name="question25"> c) is part of the central processing unit<br>
<input type="radio" value="d" name="question25"> d) all of the above<br>
</div>
