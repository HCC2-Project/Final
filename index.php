<?php // Example 26-4: index.php
  ...
  echo'<div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img class="img-circle" src="kev.jpg" alt="images(1).jpg" style="width: 140px; height: 140px;">
                ...
                <div class="col-lg-4">
                    <img class="img-circle" src="images(1).jpg" alt="images(1).jpg" style="width: 140px; height: 140px;">
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" alt="images(1).jpg">
                </div>
            </div>
